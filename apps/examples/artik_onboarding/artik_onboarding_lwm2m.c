...
static artik_lwm2m_handle g_lwm2m_handle = NULL;
static ota_info_t *g_ota_info = NULL;
struct Lwm2mState lwm2m_state;
static int g_lwm2m_connection_retries = 0;
...
static int download_firmware(int argc, char *argv[]) {
	...
	g_ota_info = malloc(sizeof(ota_info_t));
	memset(g_ota_info, 0, sizeof(ota_info_t));
